package com.siwei.tongche.jpush;
...
//			JPushInterface.clearNotificationById(context,notifactionId);//取消通知
...
//        	context.startActivity(i);
	...
	private void processCustomMessage(Context context, Bundle bundle,int notifactionId) {
		...
		String extras = bundle.getString(JPushInterface.EXTRA_EXTRA);
		MyLogUtils.e("message=="+message);
		MyLogUtils.e("extras=="+extras);
		...
		com.alibaba.fastjson.JSONObject resultData= com.alibaba.fastjson.JSONObject.parseObject(jsonObject.getString("resultData"));
		if(messageType==null){
			return;
		}
		switch (messageType){
	...
	private boolean isTopActivity(Context context)
	{
		...
		//在主页面或者聊天界面
//		if(component.getClassName().equals(MessageChatActivity.class.getName())||component.getClassName().equals(MainActivity.class.getName())){
//			return true;
//		}
		return false;
	}
