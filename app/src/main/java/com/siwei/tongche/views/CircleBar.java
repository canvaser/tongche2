...
public class CircleBar extends View {
    ...
    private int stepnumbermax = 100;// 默认最大值
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        /**
         * 设置画笔渐变色 Color.parseColor("#FCC200")
         */
        mColors = new int[]{0xFFFCC200, 0xFFFCC200, 0xFFFCC200};
        ...
        mDefaultWheelPaint.setColor(Color.rgb(214, 246, 254));
     ...
     * @param time
     */
    public void update(int stepnumber, int time,int
                       delayTime) {
        this.stepnumber = stepnumber;
        anim.setDuration(time);
        anim.setStartOffset(delayTime);
        //setAnimationTime(time);
        this.startAnimation(anim);
    }
