...
/**
 * Created by HanJinLiang on 2016-09-28.
 */
...
public class MyWheelView extends ScrollView {
    public static final String TAG = MyWheelView.class.getSimpleName();
        ...
        public interface OnWheelViewListener {
            void onSelected(int selectedIndex, String item, boolean isByUser);
        }
    ...
    public void resetItems(List<String> list) {
        ...
        private TextView createView(String item) {
            ...
            tv.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dip2px(50)));
...
//                itemHeight = getViewMeasuredHeight(tv);
        ...
        public static final int TYPE_SHENGYU=0X11;
        ...
        private void refreshItemView(int y) {
            ...
            for (int i = 0; i < childSize; i++) {
                ...
                if(mType==TYPE_NORMAL){//常规颜色设置
                    if (position == i) {
                        itemView.setTextColor(Color.parseColor("#2b2b2b"));
                    } else {
                        itemView.setTextColor(Color.parseColor("#bbbbbb"));
                    }
                }else{//剩余方量定制颜色显示
                    if (itemView.getText().equals("0")) {
                        itemView.setTextColor(Color.parseColor("#bbbbbb"));
                    } else {
        ...
        public void setBackgroundDrawable(Drawable background) {
            ...
            if (null == paint) {
                paint = new Paint();
                paint.setColor(ContextCompat.getColor(context, R.color.text_blue));
...
//                    canvas.drawLine(viewWidth * 1 / 6, obtainSelectedAreaBorder()[1], viewWidth * 5 / 6, obtainSelectedAreaBorder()[1], paint);
                    //填充
                    canvas.drawRect(new RectF(0,obtainSelectedAreaBorder()[0],viewWidth,obtainSelectedAreaBorder()[1]),paint);
                }
        ...
        private void onSeletedCallBack() {
            if (null != onWheelViewListener) {
                 try {//数据越界异常捕获
                     onWheelViewListener.onSelected(selectedIndex, items.get(selectedIndex),true);
                 }catch (IndexOutOfBoundsException e){
                     MyLogUtils.e(getClass().getName()+"onSeletedCallBack IndexOutOfBoundsException");
                     e.printStackTrace();
                 }
        ...
        public void setSeletion(int position) {
            ...
            onWheelViewListener.onSelected(selectedIndex,items.get(selectedIndex),false);
        }
